...
| TC #   | Scenario                                | Program | Starting State         | End State                       | Expected | Automation                                                                                                                                                                                      |
| ------ | --------------------------------------- | ------- | ---------------------- | ------------------------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| TC-001 | New IRIS Enrollment — Happy Path       | IRIS    | Pristine               | Enrolled (active)               | SU       | ✅ Working                                                                                                                                                                                      |
| TC-002 | Enrolled → Suspended (bounded)         | IRIS    | Enrolled               | Suspended (bounded, 3 spans)    | SU       | ✅ Working                                                                                                                                                                                      |
| TC-003 | ICA Transfer — Active Span             | IRIS    | Enrolled               | Enrolled (new ICA agency)       | SU       | ✅ Working                                                                                                                                                                                      |
| TC-004 | Hard Error — FEA Dates Don't Span      | IRIS    | Pristine               | Failed (conflict)               | FL       | how does this works?  Currently using prior enrollment. Verify with QA or BA<br />to be validated<br />The data looks correct and test case completes on UI but MMIS sync fails<br />✅ Working |
| TC-005 | Medicaid ID Mismatch                    | IRIS    | Pristine               | Enrolled (new Medicaid ID)      | SU       | how does this works?  Currently using prior enrollment. Verify with QA or BA<br />The data looks correct and test case completes on UI but MMIS sync fails<br />✅ Working                      |
| TC-006 | End Date → Earlier (Disenrollment)     | IRIS    | Enrolled               | Disenrolled (end-dated)         | SU       | The data looks correct and test case completes on UI but MMIS sync fails, errors on MMIS. Need assistance from BA<br />✅ Working                                                               |
| TC-007 | End Date → Later (Extension)           | IRIS    | Disenrolled            | Enrolled (re-opened)            | SU       | The data looks correct and test case completes on UI but MMIS sync fails, errors on MMIS. Need assistance from BA<br />✅ Working                                                               |
| TC-008 | Enrolled → Referral Withdrawn          | IRIS    | Enrolled               | Referral Withdrawn (deleted)    | SU       | ✅ Working                                                                                                                                                                                      |
| TC-009 | Disenrolled → Enrolled (Reinstatement) | IRIS    | Disenrolled            | Enrolled (reinstated)           | SU       | ✅ Working                                                                                                                                                                                      |
| TC-010 | Open-Ended Suspension (no end date)     | IRIS    | Enrolled               | Suspended (open-ended, 2 spans) | SU       | ✅ Working                                                                                                                                                                                      |
| TC-011 | Suspension < 3 Days (Error)             | IRIS    | Enrolled               | Enrolled (unchanged)            | No Txn   | ✅ Working                                                                                                                                                                                      |
| TC-012 | Suspension Deleted                      | IRIS    | Suspended (bounded)    | Enrolled (spans merged)         | SU       | ✅ Working                                                                                                                                                                                      |
| TC-013 | Suspension End: Null → Valid           | IRIS    | Suspended (open-ended) | Suspended (bounded, 3 spans)    | SU       | ✅ Working                                                                                                                                                                                      |
| TC-014 | Address-Only Update (S700)              | IRIS    | Enrolled               | Enrolled (unchanged)            | SU       | ✅ Working                                                                                                                                                                                      |
| TC-015 | New SDPC Enrollment                     | SDPC    | Pristine               | SDPC Enrolled                   | SU       | ✅ Working                                                                                                                                                                                      |
| TC-016 | FEA Transfer — Close + Open            | IRIS    | Enrolled               | Enrolled (new FEA agency)       | SU       | HOLD                                                                                                                                                                                            |
| TC-017 | ICA Transfer During Suspension          | IRIS    | Suspended (bounded)    | Suspended (new ICA)             | SU       | HOLD                                                                                                                                                                                            |
| TC-018 | New SDPC Suspension                     | SDPC    | SDPC Enrolled          | SDPC Suspended (3 spans)        | SU       | ✅ Working                                                                                                                                                                                      |
| TC-019 | Begin Date → Earlier                   | IRIS    | Enrolled               | Enrolled (earlier begin)        | SU       | ✅ Working                                                                                                                                                                                      |
| TC-020 | Begin Date → Later                     | IRIS    | Enrolled               | Enrolled (later begin)          | SU       | ✅ Working                                                                                                                                                                                      |
| TC-021 | Suspension Begin → Earlier             | IRIS    | Suspended (bounded)    | Suspended (modified)            | SU       | ✅ Working                                                                                                                                                                                      |
| TC-022 | Suspension Begin → Later               | IRIS    | Suspended (bounded)    | Suspended (modified)            | SU       | ✅ Working                                                                                                                                                                                      |
| TC-023 | Suspension End → Earlier               | IRIS    | Suspended (bounded)    | Suspended (modified)            | SU       | ✅ Working                                                                                                                                                                                      |
| TC-024 | Suspension End → Later                 | IRIS    | Suspended (bounded)    | Suspended (modified)            | SU       | ✅ Working                                                                                                                                                                                      |
| TC-025 | Suspension End: Valid → Null           | IRIS    | Suspended (bounded)    | Suspended (open-ended)          | SU       | ✅ Working                                                                                                                                                                                      |
| TC-026 | SDPC End Date → Earlier                | SDPC    | SDPC Enrolled          | SDPC Disenrolled                | SU       | ✅ Working                                                                                                                                                                                      |
| TC-027 | SDPC Suspension Deleted                 | SDPC    | SDPC Suspended         | SDPC Enrolled (merged)          | SU       | ✅ Working                                                                                                                                                                                      |
| TC-028 | End Date Later + Suspended              | IRIS    | Suspended (2 spans)    | Suspended (3 spans)             | SU       | ✅ Working                                                                                                                                                                                      |
| TC-029 | Multiple MMIS Error Segments            | IRIS    | Pristine               | Failed (multi-error)            | FL       | ✅ Working                                                                                                                                                                                      |
...
| TC-049 | Enrolled → Referral Withdrawn          | SDPC    | Enrolled               | Referral Withdrawn (deleted)    | SU       | ✅ Working                                                                                                                                                                                      |
...
**[RESET via TC-008 + RESET SCRIPT + TC-001]**
...
| 24   | TC-025 | Suspension End: Valid → Null  | Suspended (bounded, 3 spans) | Suspended (open-ended)       | 2    | SU       | ✅ Working - possibly we have a bug in carity. |
...
| 26   | TC-031 | ICA Transfer — Span-C Exists  | Suspended (bounded, 3 spans) | Suspended (new ICA on Span-C) | 3    | SU       | — Failing in Location assignments |
...
**[Re-run TC-049 + RESET SCRIPT + TC-015 to reset SDPC enrollment]**
...
**[Re-run TC-049 + RESET SCRIPT + TC-015 to reset]**
