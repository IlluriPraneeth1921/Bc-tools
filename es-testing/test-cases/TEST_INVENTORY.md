...
| TC-006 | End Date → Earlier (Disenrollment)     | IRIS    | Enrolled               | SU       | The data looks correct and test case completes on UI but MMIS sync fails, errors on MMIS. Need assistance from BA                                                                |
