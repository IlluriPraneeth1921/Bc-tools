...
| TC-004 | Hard Error — FEA Dates Don't Span      | IRIS    | Pristine               | Failed (conflict)               | FL       | ✅ Working |
| TC-005 | Medicaid ID Mismatch                    | IRIS    | Pristine               | Enrolled (new Medicaid ID)      | SU       | ✅ Working |
| TC-006 | End Date → Earlier (Disenrollment)     | IRIS    | Enrolled               | Disenrolled (end-dated)         | SU       | ✅ Working |
| TC-007 | End Date → Later (Extension)           | IRIS    | Disenrolled            | Enrolled (re-opened)            | SU       | ✅ Working |
