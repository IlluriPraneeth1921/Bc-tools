...
| TC-007 | End Date → Later (Extension)           | IRIS    | Disenrolled            | SU       | The data looks correct and test case completes on UI but MMIS sync fails, errors on MMIS. Need assistance from BATC-007E                                                         |
