...
export const SCENARIOS: Record<string, ScenarioData> = {
  ...
  TC_001: {
    ...
    mmisBefore: [],
    mmisAfter: [
      { label: 'Span-A', status: 'A', beginDate: '07/01/2026', endDate: '' },
    ],
    transactions: [
  ...
  TC_002: {
    ...
    mmisBefore: [
      { label: 'Span-A', status: 'A', beginDate: '07/01/2026', endDate: '12/31/2299' },
    ],
    mmisAfter: [
      { label: 'Span-A', status: 'A', beginDate: '07/01/2026', endDate: '08/15/2026' },
  ...
  TC_011: {
    ...
    mmisAfter: [
      { label: 'Span-A', status: 'A', beginDate: '07/01/2026', endDate: '12/31/2299' }, // Unchanged
    ],
  ...
  TC_012: {
    ...
    mmisAfter: [
      { label: 'Span-A', status: 'A', beginDate: '07/01/2026', endDate: '09/13/2026' },
      { label: 'Span-C', status: 'A', beginDate: '09/14/2026', endDate: '12/31/2299' },
    ],
    transactions: [
  ...
  TC_016: {
    ...
    mmisBefore: [
      { label: 'Span-B', status: 'A', beginDate: '07/01/2026', endDate: '12/31/2299', agency: 'FEA-001' },
    ],
    mmisAfter: [
      { label: 'Span-B', status: 'A', beginDate: '07/01/2026', endDate: '09/30/2026', agency: 'FEA-001' },
  ...
  TC_021: {
    ...
    mmisAfter: [
      { label: 'Span-A', status: 'A', beginDate: '07/01/2026', endDate: '08/01/2026' },
  ...
  TC_022: {
    ...
    mmisAfter: [
      { label: 'Span-A', status: 'A', beginDate: '07/01/2026', endDate: '09/01/2026' },
